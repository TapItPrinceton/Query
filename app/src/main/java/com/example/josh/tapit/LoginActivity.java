...
*/
    ...
    public void attemptLogin() {
        ...
        String classCode = mClassCodeView.getText().toString();
        ...
        if (TextUtils.isEmpty(classCode)) {
            ...
            cancel = true;
        } else if (!isClassCodeValid(classCode)) {
            mClassCodeView.setError(getString(R.string.error_invalid_class_code));
            focusView = mClassCodeView;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(classCode, password);
            mAuthTask.execute((Void) null);
        }
    }
    private boolean isClassCodeValid(String code) {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        //mClassCodeView.setAdapter(adapter);
    }
*/
